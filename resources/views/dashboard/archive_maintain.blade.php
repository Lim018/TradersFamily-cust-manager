    ...
    <div class="flex h-screen">
        ...
        <div class="w-72 bg-white shadow-lg border-r border-gray-200 sidebar" id="sidebar">
            ...
            <nav class="mt-6 px-4">
                ...
                <a href="{{ route('dashboard.archived_keep') }}" class="sidebar-link flex items-center px-4 py-3 text-gray-700 font-medium">
                    <i class="fas fa-archive mr-3"></i>
                    Investor
                    <span class="ml-2 text-xs font-semibold">Keep</span>
                </a>
                <a href="{{ route('dashboard.archived_maintain') }}" class="sidebar-link active flex items-center px-4 py-3 text-white font-medium">
                    <i class="fas fa-archive mr-3"></i>
                    Investor
